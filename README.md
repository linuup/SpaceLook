...
choose a file, folder, shortcut, or desktop item, press the Space key to open a lightweight preview window next to your workflow, and press the Space key again to quickly close it.
